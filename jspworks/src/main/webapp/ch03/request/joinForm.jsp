...
<body>
	...
	<form action="joinProcess.jsp" method="post">
		...
		<p>
			...
			<label><input type="radio" id="hobby" name="hobby" value="독서" checked>독서</label>
			<label><input type="radio" id="hobby" name="hobby" value="운동" >운동</label>
			<label><input type="radio" id="hobby" name="hobby" value="영화" >영화</label>
